...
MeshField::MeshField()
{
	...
	hr = D3DXCreateTextureFromFile(pDevice, "resource/texture/ground.jpg", &this->pTexture_);
	if (FAILED(hr))
	{
		MessageBox(NULL, "テクスチャ読み込み失敗", "警告", MB_OK | MB_ICONHAND);
	}
